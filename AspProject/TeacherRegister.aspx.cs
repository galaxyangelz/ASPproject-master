...
{
    public partial class TeacherRegister1 : System.Web.UI.Page
    {
        ...
        protected void Create_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd = new SqlCommand("INSERT INTO [Teacher](firstname,lastname,user_id) VALUES(@Fname,@Lname,@UserId);", con);
