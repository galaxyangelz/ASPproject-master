<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentRegister.aspx.cs" Inherits="AspProject.StudentRegister" %>
...
<body>
   ...
   <asp:Label runat="server" Text="Email"></asp:Label>
    ...
    <asp:Hyperlink runat="server" Text="Back" NavigateUrl="~/StudentLogin.aspx"></asp:Hyperlink>   
